...
export default function KnowledgeAtlas({ initialContext = {}, onOpenLegacy, onDisabled, workspaceNavigation = null }) {
  ...
  useEffect(() => {
    ...
    queueMicrotask(() => {
      if (cancelled) return;
      const nextPath = {
        lv1: initialContext.lv1 || '',
        chapter: initialContext.chapter || '',
        chapterId: initialContext.chapterId || initialContext.chapter_id || '',
        lv2: initialContext.lv2 || '',
        sectionId: initialContext.sectionId || initialContext.section_id || '',
      };
