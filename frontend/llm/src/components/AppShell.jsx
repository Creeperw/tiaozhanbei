...
export default function AppShell({ currentUser, currentPage, onNavigate, onLogout, children }) {
  ...
  const shouldShowPageHeader = shell.currentPage !== 'dashboard' && shell.shellMode !== 'workspace' && !['personalization', 'settings'].includes(shell.currentPage);
