...
run_tag="waiting10_rerun_w4"
input="outputs/cmb_batch500_waiting_review_10_rerun.json"
...
cases = load_cmb_cases("outputs/cmb_batch500_waiting_review_10_rerun.json")
