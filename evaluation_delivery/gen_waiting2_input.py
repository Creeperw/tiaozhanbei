# -*- coding: utf-8 -*-
"""按 case_id 从 cmb_batch500.json 生成重跑输入（CMB 原始格式）"""
import json
import sys
...
targets = {"cmb_0394_精神科", "cmb_0428_临床执业医师"}
...
json.dump(wanted, open(OUT + "/cmb_batch500_waiting2_rerun.json", "w", encoding="utf-8"),
          ensure_ascii=False, indent=2)
print("saved:", OUT + "/cmb_batch500_waiting2_rerun.json")
