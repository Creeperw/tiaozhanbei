...
class AssetLayout:
    ...
    def resolve(
        ...
        *,
        ...
        knowledge_delivery_root = _configured_path(
            values, "KNOWLEDGE_HANDOFF_ROOT", base=backend_root
        ) or manifest_knowledge or default_knowledge
...
def resolve_platform_backend_root(
    ...
    configured = _configured_path(values, "BACKEND_HANDOFF_ROOT", base=backend_root)
