...
4. 问诊内容-望闻问切（满分15分）：仔细分析对话历史，医生系统询问起病时间、症状特点、既往史得12-15分；询问核心症状得7-11分；简单问几句得3-6分；未有效问诊得0分
5. 问诊时间与效率（满分8分）：系统自动计算，你给任意值即可
6. 人文关怀（满分7分）：医生表达共情（"别担心""我来帮您"）、耐心解释得5-7分；有礼貌问候得3-4分；态度生硬得0-2分
