...
class Settings:
    ...
    def from_env(cls, environ: Mapping[str, str] | None = None) -> "Settings":
        ...
        return cls(
            ...
            treekg_root=_parse_path(values, "TREEKG_ROOT", DEFAULT_TREEKG_ROOT, base=REPOSITORY_ROOT),
            treekg_python=values.get("TREEKG_PYTHON", "").strip(),
            treekg_api_key=values.get("TREEKG_API_KEY") or None,
            treekg_api_base=values.get("TREEKG_API_BASE", "https://api.deepseek.com").strip(),
            treekg_model_name=values.get("TREEKG_MODEL_NAME", "deepseek-v4-flash").strip(),
