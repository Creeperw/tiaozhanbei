...
def run():
    ...
    output_dir = get_output_dir("hidden")
    ...
    if not names:
        result = {
            "summary": {
                "pairs_raw": 0, "pairs_after_filter": 0, "pairs_to_llm": 0,
                "llm_calls": 0, "fallback_calls": 0, "merged_edges": 0,
                "entities_before": len(entities), "entities_after": len(entities),
            },
            "entities": entities,
            "clusters": [],
            "merge_map": {},
        ...
        logger.info("empty entities: skip dedup")
        return
