...
- 平台首页直接联动资格考试目标与倒计时、个性化阶段路线、长短期规划正文、今日学习动态和到期复习队列；阶段卡可进入完整路线，四个快捷入口可继续进入问答、图谱、教材资料和专题训练；
...
- 训练工坊以总览聚合专项训练、智能组卷、综合套题、AI 病患模拟、错题库、知识收藏和学习笔记；收藏簿与笔记本由服务端按用户隔离并持久化；
